      ...
      <GradientBars bars={20} colors={['#e2733b', 'transparent']} />
        ...
        <div className="flex gap-8 py-20 lg:pt-40 px-4 items-start md:items-center justify-center flex-col relative z-10">
          <div ref={badgeRef} className="hidden md:block">
            <div
              ref={badgeGradientBorderRef}
              className="relative p-[2px] rounded-lg overflow-hidden inline-block"
              style={{
                background:
                  "linear-gradient(90deg, #e8e7e3)",
            ...
            >
              <Button
                variant="secondary"
                size="sm"
                className={`gap-4 ${geistSans.className} relative z-10 bg-background`}
              >
          ...
          <div className="flex gap-4 flex-col items-center justify-center">
            <h1
              ...
              className={`text-5xl md:text-7xl max-w-2xl tracking-tighter md:text-center font-medium ${geistSans.className}`}
            >
            ...
            >
              Dubai&apos;s premier 360° digital marketing agency delivering
              data-driven strategies, creative excellence, and measurable
              growth. From startups to enterprises, we transform businesses into
              market leaders
            </p>
          </div>
          ...
          <div className="flex flex-row mt-4 w-[95%] items-center justify-center">
            <div className="flex flex-col w-full">
              <div className="relative flex overflow-hidden">
                <div ref={marqueeRef} className="flex whitespace-nowrap">
                  <h2 className={`text-base  ${jetBrainsMono.className} mx-4`}>
                    Trusted by 100+ businesses across UAE • 5M+ AED generated for clients • 500K+ leads delivered
                  </h2>
                  <h2 className={`text-base  ${jetBrainsMono.className} mx-4`}>
                    Trusted by 100+ businesses across UAE • 5M+ AED generated for clients • 500K+ leads delivered
                  </h2>
