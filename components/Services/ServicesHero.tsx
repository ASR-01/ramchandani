        ...
        <div className="flex gap-8 py-20 lg:pt-40 px-4 items-start md:items-center justify-center flex-col relative z-10">
          ...
          <div className="flex gap-4 flex-col items-center justify-center">
            <h1
              ...
              className={`text-4xl md:text-7xl max-w-3xl tracking-tighter md:text-center font-medium ${geistSans.className}`}
            >
             Comprehensive Digital Solutions That Drive Real Growth
            </h1>
            <p
              ref={descriptionRef}
              className={`text-lg md:text-xl leading-relaxed tracking-tight text-black/60 max-w-2xl md:text-center ${geistSans.className}`}
            >
            From strategy to execution, from design to development—everything your
